...
; CHECK: OpFunction
; CHECK: [[var:%\w+]] = OpVariable [[:%\w+]] Function [[false]]
; CHECK: OpSelectionMerge [[placeholder_loop_merge:%\w+]]
; CHECK: OpSelectionMerge [[merge_lab:%\w+]]
; CHECK: OpBranchConditional [[cond:%\w+]] [[if_lab:%\w+]] [[then_lab:%\w+]]
; CHECK: [[if_lab]] = OpLabel
...
; CHECK: [[then_lab]] = OpLabel
; CHECK-NEXT: OpStore [[var]] [[true]]
; CHECK-NEXT: OpBranch [[placeholder_loop_merge]]
; CHECK: [[merge_lab]] = OpLabel
; CHECK: [[placeholder_loop_merge]] = OpLabel
; CHECK-NEXT: OpReturn
OpCapability Addresses
OpCapability Shader
OpCapability Linkage
...
; CHECK: OpBranchConditional {{%\w+}} [[placeholder_loop_merge]] [[old_code_path:%\w+]]
...
; CHECK-NOT: OpLabel
; CHECK: OpBranchConditional [[ld]] [[placeholder_loop_merge]] [[empty_block:%\w+]]
...
; CHECK-NOT: OpLabel
; CHECK: OpBranchConditional {{%\w+}} [[placeholder_loop_merge]]
; CHECK: [[placeholder_loop_merge]] = OpLabel
; CHECK-NOT: OpLabel
; CHECK: OpReturn
               OpCapability SampledBuffer
