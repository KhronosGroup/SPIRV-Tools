...
class GlobalValuesAmountTest : public spvtest::LinkerTest {
 public:
  GlobalValuesAmountTest() { binaries.reserve(0xFFFF); }
...
TEST_F(GlobalValuesAmountTest, UnderLimit) {
...
TEST_F(GlobalValuesAmountTest, OverLimit) {
  binaries.push_back({SpvMagicNumber,
                      SpvVersion,
                      SPV_GENERATOR_CODEPLAY,
                      5u,  // NOTE: Bound
