...
TEST(TransformationReplaceBooleanConstantWithConstantBinaryTest,
  ...
  std::vector<protobufs::IdUseDescriptor> uses_of_true = {
      module_navigation::MakeIdUseDescriptor(41, SpvOpStore, 1, 44, 12),
      module_navigation::MakeIdUseDescriptor(41, SpvOpLogicalOr, 0, 46, 0)};

  std::vector<protobufs::IdUseDescriptor> uses_of_false = {
      module_navigation::MakeIdUseDescriptor(43, SpvOpStore, 1, 44, 13),
      module_navigation::MakeIdUseDescriptor(43, SpvOpLogicalAnd, 1, 48, 0)};
