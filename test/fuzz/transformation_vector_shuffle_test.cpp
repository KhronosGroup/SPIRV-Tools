...
TEST(TransformationVectorShuffle, BasicTest) {
  ...
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(10, {}, 1),
                                  MakeDataDescriptor(12, {0}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(11, {}, 1),
                                  MakeDataDescriptor(12, {1}, 1));

  fact_manager.AddFactDataSynonym(MakeDataDescriptor(10, {}, 1),
                                  MakeDataDescriptor(16, {0}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(11, {}, 1),
                                  MakeDataDescriptor(16, {1}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(10, {}, 1),
                                  MakeDataDescriptor(16, {2}, 1));

  fact_manager.AddFactDataSynonym(MakeDataDescriptor(10, {}, 1),
                                  MakeDataDescriptor(20, {0}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(11, {}, 1),
                                  MakeDataDescriptor(20, {1}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(10, {}, 1),
                                  MakeDataDescriptor(20, {2}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(11, {}, 1),
                                  MakeDataDescriptor(20, {3}, 1));

  fact_manager.AddFactDataSynonym(MakeDataDescriptor(25, {}, 1),
                                  MakeDataDescriptor(27, {0}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(26, {}, 1),
                                  MakeDataDescriptor(27, {1}, 1));

  fact_manager.AddFactDataSynonym(MakeDataDescriptor(25, {}, 1),
                                  MakeDataDescriptor(31, {0}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(26, {}, 1),
                                  MakeDataDescriptor(31, {1}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(25, {}, 1),
                                  MakeDataDescriptor(31, {2}, 1));

  fact_manager.AddFactDataSynonym(MakeDataDescriptor(25, {}, 1),
                                  MakeDataDescriptor(35, {0}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(26, {}, 1),
                                  MakeDataDescriptor(35, {1}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(25, {}, 1),
                                  MakeDataDescriptor(35, {2}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(26, {}, 1),
                                  MakeDataDescriptor(35, {3}, 1));

  fact_manager.AddFactDataSynonym(MakeDataDescriptor(40, {}, 1),
                                  MakeDataDescriptor(42, {0}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(41, {}, 1),
                                  MakeDataDescriptor(42, {1}, 1));

  fact_manager.AddFactDataSynonym(MakeDataDescriptor(40, {}, 1),
                                  MakeDataDescriptor(46, {0}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(41, {}, 1),
                                  MakeDataDescriptor(46, {1}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(40, {}, 1),
                                  MakeDataDescriptor(46, {2}, 1));

  fact_manager.AddFactDataSynonym(MakeDataDescriptor(40, {}, 1),
                                  MakeDataDescriptor(50, {0}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(41, {}, 1),
                                  MakeDataDescriptor(50, {1}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(40, {}, 1),
                                  MakeDataDescriptor(50, {2}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(41, {}, 1),
                                  MakeDataDescriptor(50, {3}, 1));

  fact_manager.AddFactDataSynonym(MakeDataDescriptor(55, {}, 1),
                                  MakeDataDescriptor(57, {0}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(56, {}, 1),
                                  MakeDataDescriptor(57, {1}, 1));

  fact_manager.AddFactDataSynonym(MakeDataDescriptor(55, {}, 1),
                                  MakeDataDescriptor(61, {0}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(56, {}, 1),
                                  MakeDataDescriptor(61, {1}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(55, {}, 1),
                                  MakeDataDescriptor(61, {2}, 1));

  fact_manager.AddFactDataSynonym(MakeDataDescriptor(55, {}, 1),
                                  MakeDataDescriptor(65, {0}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(56, {}, 1),
                                  MakeDataDescriptor(65, {1}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(55, {}, 1),
                                  MakeDataDescriptor(65, {2}, 1));
  fact_manager.AddFactDataSynonym(MakeDataDescriptor(56, {}, 1),
                                  MakeDataDescriptor(65, {3}, 1));
  ...
  temp_dd = MakeDataDescriptor(200, {0}, 1);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(11).count(&temp_dd) == 1);
  temp_dd = MakeDataDescriptor(200, {1}, 1);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(10).count(&temp_dd) == 1);
  ...
  temp_dd = MakeDataDescriptor(201, {1}, 1);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(11).count(&temp_dd) == 1);
  temp_dd = MakeDataDescriptor(201, {2}, 1);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(11).count(&temp_dd) == 1);
  ...
  temp_dd = MakeDataDescriptor(202, {0}, 1);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(26).count(&temp_dd) == 1);
  temp_dd = MakeDataDescriptor(202, {1}, 1);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(25).count(&temp_dd) == 1);
  temp_dd = MakeDataDescriptor(202, {2}, 1);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(26).count(&temp_dd) == 1);
  ...
  temp_dd = MakeDataDescriptor(203, {0}, 1);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(40).count(&temp_dd) == 1);
  temp_dd = MakeDataDescriptor(203, {1}, 1);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(41).count(&temp_dd) == 1);
  temp_dd = MakeDataDescriptor(42, {0}, 2);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(203).count(&temp_dd) == 1);
  ...
  temp_dd = MakeDataDescriptor(204, {0}, 1);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(40).count(&temp_dd) == 1);
  temp_dd = MakeDataDescriptor(204, {1}, 1);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(41).count(&temp_dd) == 1);
  temp_dd = MakeDataDescriptor(204, {2}, 1);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(40).count(&temp_dd) == 1);
  temp_dd = MakeDataDescriptor(46, {0}, 2);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(204).count(&temp_dd) == 1);
  ...
  temp_dd = MakeDataDescriptor(205, {0}, 1);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(40).count(&temp_dd) == 1);
  temp_dd = MakeDataDescriptor(205, {1}, 1);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(41).count(&temp_dd) == 1);
  temp_dd = MakeDataDescriptor(205, {2}, 1);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(40).count(&temp_dd) == 1);
  temp_dd = MakeDataDescriptor(205, {3}, 1);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(41).count(&temp_dd) == 1);
  ...
  temp_dd = MakeDataDescriptor(206, {1}, 1);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(56).count(&temp_dd) == 1);
  temp_dd = MakeDataDescriptor(206, {1}, 2);
  ASSERT_TRUE(fact_manager.GetSynonymsForId(56).count(&temp_dd) == 1);
