...
TEST(TransformationVectorShuffle, HandlesIrrelevantFirstVector) {
  std::string shader = R"(
               OpCapability Shader
          %1 = OpExtInstImport "GLSL.std.450"
               OpMemoryModel Logical GLSL450
  ...
  // Handles irrelevant ids correctly.
...
TEST(TransformationVectorShuffle, HandlesIrrelevantSecondVector) {
  std::string shader = R"(
               OpCapability Shader
          %1 = OpExtInstImport "GLSL.std.450"
               OpMemoryModel Logical GLSL450
