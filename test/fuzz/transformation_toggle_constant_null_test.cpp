...
TEST(TransformationToggleConstantNullTest, IntConstantTest) {
  ...
  auto transformation1 = TransformationToggleConstantNull(9);
  ASSERT_TRUE(
      transformation1.IsApplicable(context.get(), transformation_context));
  transformation1.Apply(context.get(), &transformation_context);

  // The transformation can be applied to instruction %11
  auto transformation2 = TransformationToggleConstantNull(11);
  ASSERT_TRUE(
...
TEST(TransformationToggleConstantNullTest, BoolConstantTest) {
  ...
  auto transformation = TransformationToggleConstantNull(9);
  ASSERT_TRUE(
  ...
  // After toggling instruction 9 again, the result should be equivalent to
  // the beginning.
