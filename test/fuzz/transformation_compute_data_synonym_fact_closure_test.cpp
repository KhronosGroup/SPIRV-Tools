...
TEST(TransformationComputeDataSynonymFactClosureTest, DataSynonymFacts) {
  ...
  transformation_context.GetFactManager()->AddFactDataSynonym(
      MakeDataDescriptor(27, {0}), MakeDataDescriptor(102, {0}), context.get());
  ASSERT_FALSE(transformation_context.GetFactManager()->IsSynonymous(
      MakeDataDescriptor(27, {}), MakeDataDescriptor(102, {})));
  ASSERT_TRUE(transformation_context.GetFactManager()->IsSynonymous(
      MakeDataDescriptor(27, {0}), MakeDataDescriptor(102, {0})));
  ASSERT_FALSE(transformation_context.GetFactManager()->IsSynonymous(
      MakeDataDescriptor(27, {1}), MakeDataDescriptor(102, {1})));
  transformation_context.GetFactManager()->AddFactDataSynonym(
      MakeDataDescriptor(27, {1}), MakeDataDescriptor(102, {1}), context.get());
  ...
  transformation_context.GetFactManager()->AddFactDataSynonym(
      MakeDataDescriptor(34, {0}), MakeDataDescriptor(105, {0}), context.get());
  transformation_context.GetFactManager()->AddFactDataSynonym(
      MakeDataDescriptor(34, {1}), MakeDataDescriptor(105, {1}), context.get());
  transformation_context.GetFactManager()->AddFactDataSynonym(
      MakeDataDescriptor(34, {2}), MakeDataDescriptor(105, {2}), context.get());
  ASSERT_TRUE(transformation_context.GetFactManager()->IsSynonymous(
      MakeDataDescriptor(30, {}), MakeDataDescriptor(103, {})));
  ASSERT_TRUE(transformation_context.GetFactManager()->IsSynonymous(
      MakeDataDescriptor(30, {0}), MakeDataDescriptor(103, {0})));
  ...
  transformation_context.GetFactManager()->AddFactDataSynonym(
      MakeDataDescriptor(34, {3}), MakeDataDescriptor(105, {3}), context.get());
  ASSERT_TRUE(transformation_context.GetFactManager()->IsSynonymous(
      MakeDataDescriptor(33, {0}), MakeDataDescriptor(104, {0})));
  ASSERT_TRUE(transformation_context.GetFactManager()->IsSynonymous(
      MakeDataDescriptor(34, {3}), MakeDataDescriptor(105, {3})));
  ...
  transformation_context.GetFactManager()->AddFactDataSynonym(
      MakeDataDescriptor(21, {0}), MakeDataDescriptor(100, {0}), context.get());
  transformation_context.GetFactManager()->AddFactDataSynonym(
      MakeDataDescriptor(21, {1}), MakeDataDescriptor(100, {1}), context.get());
  transformation_context.GetFactManager()->AddFactDataSynonym(
      MakeDataDescriptor(21, {2}), MakeDataDescriptor(100, {2}), context.get());
  transformation_context.GetFactManager()->AddFactDataSynonym(
      MakeDataDescriptor(21, {3}), MakeDataDescriptor(100, {3}), context.get());
  transformation_context.GetFactManager()->AddFactDataSynonym(
      MakeDataDescriptor(21, {4}), MakeDataDescriptor(100, {4}), context.get());
  ...
  transformation_context.GetFactManager()->AddFactDataSynonym(
      MakeDataDescriptor(39, {0}), MakeDataDescriptor(35, {}), context.get());
  ASSERT_FALSE(transformation_context.GetFactManager()->IsSynonymous(
      MakeDataDescriptor(39, {0}), MakeDataDescriptor(107, {0})));
  ASSERT_TRUE(transformation_context.GetFactManager()->IsSynonymous(
      MakeDataDescriptor(35, {}), MakeDataDescriptor(39, {0})));
  ...
  transformation_context.GetFactManager()->AddFactDataSynonym(
      MakeDataDescriptor(107, {0}), MakeDataDescriptor(35, {}), context.get());
  transformation_context.GetFactManager()->AddFactDataSynonym(
      MakeDataDescriptor(40, {0}), MakeDataDescriptor(108, {0}), context.get());
  transformation_context.GetFactManager()->AddFactDataSynonym(
      MakeDataDescriptor(40, {1}), MakeDataDescriptor(108, {1}), context.get());
  transformation_context.GetFactManager()->AddFactDataSynonym(
      MakeDataDescriptor(40, {2}), MakeDataDescriptor(108, {2}), context.get());
