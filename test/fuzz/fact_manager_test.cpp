...
TEST(FactManagerTest, HandlesCorollariesWithInvalidIds) {
  ...
  transformation_context.GetFactManager()->AddFactIdEquation(
      14, SpvOpConvertSToF, {9}, context.get());
  transformation_context.GetFactManager()->AddFactDataSynonym(
      MakeDataDescriptor(14, {}), MakeDataDescriptor(17, {}), context.get());
  ...
  transformation_context.GetFactManager()->AddFactIdEquation(
      15, SpvOpConvertSToF, {9}, context.get());
  ...
  transformation_context.GetFactManager()->AddFactIdEquation(
      18, SpvOpConvertSToF, {9}, context.get());
