...
enum spv_type_category_t {
  SPV_TYPE_CATEGORY_NONE = 0,
  SPV_TYPE_CATEGORY_TYPE_VOID = SPV_BIT(0),
  SPV_TYPE_CATEGORY_TYPE_BOOL = SPV_BIT(1),
  SPV_TYPE_CATEGORY_TYPE_INT = SPV_BIT(2),
  SPV_TYPE_CATEGORY_TYPE_FLOAT = SPV_BIT(3),
  SPV_TYPE_CATEGORY_TYPE_IMAGE = SPV_BIT(4),
  SPV_TYPE_CATEGORY_TYPE_SAMPLER = SPV_BIT(5),
  SPV_TYPE_CATEGORY_TYPE_VECTOR = SPV_BIT(6),
  SPV_TYPE_CATEGORY_TYPE_MATRIX = SPV_BIT(7),
  SPV_TYPE_CATEGORY_TYPE_ARRAY = SPV_BIT(8),
  SPV_TYPE_CATEGORY_TYPE_RUNTIMEARRAY = SPV_BIT(9),
  SPV_TYPE_CATEGORY_TYPE_STRUCT = SPV_BIT(10),
  SPV_TYPE_CATEGORY_TYPE_SAMPLEDIMAGE = SPV_BIT(11),
  SPV_TYPE_CATEGORY_TYPE_FUNCTION = SPV_BIT(12),
  SPV_TYPE_CATEGORY_TYPE_OPAQUE = SPV_BIT(13),
  SPV_TYPE_CATEGORY_TYPE_POINTER = SPV_BIT(14),
  SPV_TYPE_CATEGORY_TYPE_EVENT = SPV_BIT(15),
  SPV_TYPE_CATEGORY_TYPE_DEVICEEVENT = SPV_BIT(16),
  SPV_TYPE_CATEGORY_TYPE_RESERVEID = SPV_BIT(17),
  SPV_TYPE_CATEGORY_TYPE_QUEUE = SPV_BIT(18),
  SPV_TYPE_CATEGORY_TYPE_PIPE = SPV_BIT(19),
  SPV_TYPE_CATEGORY_TYPE_FORWARDPOINTER = SPV_BIT(20),

  SPV_TYPE_CATEGORY_NUMERICAL =
      SPV_TYPE_CATEGORY_TYPE_INT | SPV_TYPE_CATEGORY_TYPE_FLOAT,
  SPV_TYPE_CATEGORY_SCALAR =
      SPV_TYPE_CATEGORY_NUMERICAL | SPV_TYPE_CATEGORY_TYPE_BOOL,
  SPV_TYPE_CATEGORY_AGGREGATE =
      SPV_TYPE_CATEGORY_TYPE_STRUCT | SPV_TYPE_CATEGORY_TYPE_ARRAY,
  SPV_TYPE_CATEGORY_COMPOSITE = SPV_TYPE_CATEGORY_AGGREGATE |
                                SPV_TYPE_CATEGORY_TYPE_MATRIX |
                                SPV_TYPE_CATEGORY_TYPE_VECTOR,
  SPV_TYPE_CATEGORY_CONCRETE = SPV_TYPE_CATEGORY_SCALAR |
                               SPV_TYPE_CATEGORY_TYPE_VECTOR |
                               SPV_TYPE_CATEGORY_TYPE_MATRIX,
  //  or a pointer when using physical addressing model
  SPV_TYPE_CATEGORY_ABSTRACT = SPV_TYPE_CATEGORY_TYPE_VOID |
                               SPV_TYPE_CATEGORY_TYPE_BOOL |
                               SPV_TYPE_CATEGORY_TYPE_POINTER,
  SPV_TYPE_CATEGORY_OPAQUE =
      SPV_TYPE_CATEGORY_TYPE_IMAGE | SPV_TYPE_CATEGORY_TYPE_SAMPLER |
      SPV_TYPE_CATEGORY_TYPE_SAMPLEDIMAGE | SPV_TYPE_CATEGORY_TYPE_OPAQUE |
      SPV_TYPE_CATEGORY_TYPE_EVENT | SPV_TYPE_CATEGORY_TYPE_DEVICEEVENT |
      SPV_TYPE_CATEGORY_TYPE_RESERVEID | SPV_TYPE_CATEGORY_TYPE_QUEUE |
      SPV_TYPE_CATEGORY_TYPE_PIPE | SPV_TYPE_CATEGORY_TYPE_FORWARDPOINTER,
  SPV_TYPE_CATEGORY_ANY = 0xFFFFFFFF,
};
