...
//
//   CreateInstBindlessCheckPass(uint32_t desc_set, uint32_t shader_id)
//   where |desc_set| is the descriptor set containing the output buffer
//   to be written, and |shader_id| is a value that identifies the shader
//   being instrumented. This value is written into every error record
//   generated by that shader.
