...
class Differ {
 ...
 private:
  ...
  uint32_t GroupIdsHelperGetFunctionTypeId(const IdInstructions& id_to, uint32_t id);
...
void Differ::MatchFunctions() {
  ...
  GroupIdsAndMatchByMappedId(
      ...
      [this](const IdGroup& src_group_by_func_type_id,
        ...
        BestEffortMatchFunctions(src_group_by_func_type_id, dst_group_by_func_type_id,
