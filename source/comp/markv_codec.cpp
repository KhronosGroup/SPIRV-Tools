...
spv_result_t MarkvEncoder::EncodeInstruction(
  ...
  // TODO(atgoo@github.com) Implement forward id declaration support.
  assert(vstate_.unresolved_forward_id_count() == 0 &&
         "Forward declared id support not yet implemented");
  ...
  for (const auto& operand : operands) {
    if (operand.type == SPV_OPERAND_TYPE_RESULT_ID) {
      ...
      // TODO(atgoo@github.com): Support forward declared ids.
