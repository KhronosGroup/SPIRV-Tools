...
class BuiltInsValidator {
 ...
 private:
  ...
  bool HasInterfaceVariableForMeshEntryPoint(spv::BuiltIn builtin, uint32_t entry_point) {
  ...
  void RegisterMeshEntryPointForBuiltin(spv::BuiltIn builtin, uint32_t entry_point) {
