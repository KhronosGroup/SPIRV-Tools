...
class DebugInfoManager {
 public:
  ...
  // Generates a DebugValue instruction with value |value_id| for local
  // variable whose memory is |variable_id| and inserts it after the
  // instruction |insert_pos|. Returns whether a DebugValue is added or not.
  bool AddDebugValueForVariable(uint32_t variable_id, uint32_t value_id,
  ...
  // |dbg_decl|. The new DebugValue has the same operands as DebugDeclare
