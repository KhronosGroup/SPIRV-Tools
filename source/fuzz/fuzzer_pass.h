...
class FuzzerPass {
 ...
 protected:
  ...
  // PointeeValueIsIrrelevant set according to |pointee_value_is_irrelevant|. If
  // there is no such variable, it creates one in the |function| adding a zero
  // initializer constant that is irrelevant. The new variable has the fact
  // PointeeValueIsIrrelevant set according to |pointee_value_is_irrelevant|.
  // The function returns the id of the created variable.
  ...
  // PointeeValueIsIrrelevant set according to |pointee_value_is_irrelevant|. If
  // there is no such variable, it creates one, adding a zero initializer
  // constant that is irrelevant. The new variable has the fact
  // PointeeValueIsIrrelevant set according to |pointee_value_is_irrelevant|.
  // The function returns the id of the created variable.
