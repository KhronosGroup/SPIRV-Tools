...
const std::pair<uint32_t, uint32_t> kChanceOfChangingMemorySemantics = {30, 90};
...
FuzzerContext::FuzzerContext(std::unique_ptr<RandomGenerator> random_generator,
  ...
  chance_of_changing_memory_semantics_ =
      ChooseBetweenMinAndMax(kChanceOfChangingMemorySemantics);
