...
#ifndef SOURCE_FUZZ_TRANSFORMATION_INVERT_COMPARISON_OPERATORS_H_
#define SOURCE_FUZZ_TRANSFORMATION_INVERT_COMPARISON_OPERATORS_H_
...
class TransformationInvertComparisonOperators : public Transformation {
 public:
  explicit TransformationInvertComparisonOperators(
...
#endif  // SOURCE_FUZZ_TRANSFORMATION_INVERT_COMPARISON_OPERATORS_H_
