...
#ifndef SOURCE_FUZZ_TRANSFORMATION_COMPOSITE_INSERT_H
#define SOURCE_FUZZ_TRANSFORMATION_COMPOSITE_INSERT_H
...
#endif  // SOURCE_FUZZ_TRANSFORMATION_COMPOSITE_INSERT_H
