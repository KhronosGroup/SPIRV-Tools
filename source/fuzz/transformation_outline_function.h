...
class TransformationOutlineFunction : public Transformation {
 public:
  ...
  // - uses inside the region of ids defined by OpPhi instructions in
  //   |region_entry_block| are treated as input ids
  ...
  // - ids generated by OpPhi instructions in |region_entry_block| do not count
  //   as output ids
