...
Transformation::FromMessage(const protobufs::Transformation &message) {
  ...
  case protobufs::Transformation::TransformationCase::kAddBitInstructionSynonym:
  ...
  case protobufs::Transformation::TransformationCase::kAddGlobalUndef:
    return MakeUnique<TransformationAddGlobalUndef>(message.add_global_undef());
  ...
  case protobufs::Transformation::TransformationCase::kAddTypeBoolean:
    return MakeUnique<TransformationAddTypeBoolean>(message.add_type_boolean());
  ...
  case protobufs::Transformation::TransformationCase::kAddTypePointer:
    return MakeUnique<TransformationAddTypePointer>(message.add_type_pointer());
  ...
  case protobufs::Transformation::TransformationCase::kFlattenConditionalBranch:
  ...
  case protobufs::Transformation::TransformationCase::kInlineFunction:
    return MakeUnique<TransformationInlineFunction>(message.inline_function());
  case protobufs::Transformation::TransformationCase::kInvertComparisonOperator:
  ...
  case protobufs::Transformation::TransformationCase::kPropagateInstructionDown:
  ...
  case protobufs::Transformation::TransformationCase::kReplaceParamsWithStruct:
  ...
  case protobufs::Transformation::TransformationCase::kSetLoopControl:
    return MakeUnique<TransformationSetLoopControl>(message.set_loop_control());
