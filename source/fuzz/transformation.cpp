...
std::unique_ptr<Transformation> Transformation::FromMessage(
  ...
  switch (message.transformation_case()) {
    ...
    case protobufs::Transformation::TransformationCase::kAddEarlyTerminationWrapper:
      return MakeUnique<TransformationAddEarlyTerminationWrapper>(
          message.add_early_termination_wrapper());
