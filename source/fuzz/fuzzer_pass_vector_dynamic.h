...
#ifndef SOURCE_FUZZ_FUZZER_PASS_VECTOR_DYNAMIC_H_
#define SOURCE_FUZZ_FUZZER_PASS_VECTOR_DYNAMIC_H_
...
class FuzzerPassVectorDynamic : public FuzzerPass {
 public:
  ...
  ~FuzzerPassVectorDynamic() override;
...
#endif  // SOURCE_FUZZ_FUZZER_PASS_VECTOR_DYNAMIC_H_
