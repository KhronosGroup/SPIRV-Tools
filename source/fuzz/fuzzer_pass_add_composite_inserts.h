...
#ifndef SOURCE_FUZZ_FUZZER_PASS_ADD_COMPOSITE_INSERTS_H
#define SOURCE_FUZZ_FUZZER_PASS_ADD_COMPOSITE_INSERTS_H
...
#endif  // SOURCE_FUZZ_FUZZER_PASS_ADD_COMPOSITE_INSERTS_H
