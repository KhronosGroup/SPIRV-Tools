...
class TransformationContext {
 public:
  // Constructs a transformation context with the given |fact_manager| and
  // |validator_options|.  Overflow ids are not available from a transformation
  // context constructed in this way.
  TransformationContext(std::unique_ptr<FactManager> fact_manager,
                        spv_validator_options validator_options);

  // Constructs a transformation context with the given |fact_manager|,
  // |validator_options| and |overflow_id_source|.
  TransformationContext(std::unique_ptr<FactManager> fact_manager,
                        spv_validator_options validator_options,
